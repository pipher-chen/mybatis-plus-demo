...
public class Generator {
    ...
    //作者
    private static final String author = "pipher";

    //数据库
    private static final String url = "jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
    ...
    //生成在该目录下
    private static final String package_name = "com.example.mp";
